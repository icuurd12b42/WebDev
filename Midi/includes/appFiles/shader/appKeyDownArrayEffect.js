//this object does keydown effect with a shader using notes given by the midikeyboarddevice object
class appKeyDownArrayEffect extends appModule
{
    ...
    onDrawFrame(now)
    {
        ...
        for (var i = this.notesArray.length-1;i>=0;i--)
        {
            ...
            note.ndeFastForce*=.666;
            note.ndeFastForce+=note.velocity/2;
            note.ndeFastForce=Math.min(note.ndeFastForce,1);
