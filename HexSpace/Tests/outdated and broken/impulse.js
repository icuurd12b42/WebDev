...
class Ship extends Entity
{
    ...
    onThink()
    {
        ...
        {
            vec2a.x = (inputs.D.down()=inputs.A.down()) * 100;
            vec2a.y = (inputs.S.down()=inputs.W.down()) * 100;
            vec2b.x = 0;
            vec2b.y = 0;
...
*/
            if(inputs.MOUSE.RIGHT.pressed() || inputs.MOUSE.RIGHT.downTime()>200)
            {
                ...
                this.points.push(new Vector2D(inputs.MOUSE.event.clientX /  globals.view.zoom.factor - world.pos.x,
                                            inputs.MOUSE.event.clientY / globals.view.zoom.factor - world.pos.y));
            }
        }
    }
}
